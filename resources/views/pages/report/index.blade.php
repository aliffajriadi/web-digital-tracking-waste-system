...
@section('title', 'Laporan | WasteTracking')
...
<div class="max-w-7xl mx-auto space-y-5">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h2 class="text-lg font-extrabold text-gray-800">Daftar Laporan</h2>
            <p class="text-xs text-gray-400 mt-0.5">Catatan dan laporan yang dibuat oleh PIC.</p>
        </div>
    </div>
    ...
    <form method="GET" class="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 flex gap-3">
        ...
        @if(request('search'))
        <a href="{{ route('admin.report.index') }}" class="h-9 px-4 border border-gray-200 text-gray-500 text-xs font-bold rounded-xl hover:bg-gray-50 flex items-center">Reset</a>
        @endif
    </form>
        ...
        <table class="w-full text-sm">
            <thead class="bg-gray-50/80">
                <tr>
                    ...
                    <th class="px-6 py-3.5 text-left text-[10px] font-bold text-gray-400 uppercase tracking-wider">Isi</th>
